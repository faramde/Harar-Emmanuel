 ...
 */
console.log('jquery tinymce top');
...
console.log('jquery tinymce fn.tinymce');			
		...
		function init() {
console.log('jquery tinymce init');			
...
console.log('jq tiny editors:');
console.log(editors);
			// Render the editor instances in a separate loop since we
			// need to have the full editors array used in the onInit calls
			$.each(editors, function(i, ed) {
console.log('   jq tiny editor loop:');
console.log(ed);
				ed.render();
			});
		}
